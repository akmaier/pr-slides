...
% \setcounter{section}{0} \input{00_organization}
% \setcounter{section}{1} \input{01_introduction}
% \setcounter{section}{2} \input{02_bayes_classifier} 
% \setcounter{section}{3} \input{03_logistic_regression}
% \setcounter{section}{4} \input{04_logistic_regression_2}
% \setcounter{section}{5} \input{05_naive_bayes}
% \setcounter{section}{6} \input{06_discriminant_analysis}
% \setcounter{section}{7} \input{07_discriminant_analysis_2}
% \setcounter{section}{8} \input{08_norms}
\setcounter{section}{9} \input{09_perceptron}
% \setcounter{section}{10} \input{10_mlp}
% \setcounter{section}{11} \input{11_optimization}
% \setcounter{section}{12} \input{12_svm}
% \setcounter{section}{13} \input{13_optimization_2}
% \setcounter{section}{14} \input{14_svm_2}
% \setcounter{section}{15} \input{15_kernels}
% \setcounter{section}{16} \input{16_lapsvm}
% Ab hier struktex
% \setcounter{section}{17} \input{17_em}
% \setcounter{section}{18} \input{18_em_applications}
% \setcounter{section}{19} \input{19_ica}
% \setcounter{section}{20} \input{20_model_assessment}
% \setcounter{section}{21} \input{21_adaboost}
